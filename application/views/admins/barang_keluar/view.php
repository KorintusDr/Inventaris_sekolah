                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?= site_url('barang_keluar/export') ?>" class="btn btn-success">
                                <i class="fas fa-file-excel"></i> Export ke Excel
                            </a>
                            <a href="<?= site_url('barang_keluar/pdf') ?>" class="btn btn-danger" target="_blank">
                                <i class="fas fa-file-pdf"></i> Export ke PDF
                            </a>
                                <a href="<?= base_url('barang_keluar/tambah') ?>" class="btn btn-primary">
                                        ...
                                        <?php foreach ($barang_keluar as $key => $item): ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="<?= base_url('barang_keluar/edit/' . $item['id_barang_keluar']) ?>" class="btn btn-info btn-xs">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>
                                                    <a href="#" class="btn btn-danger btn-xs" onclick="confirmDelete('<?= base_url('barang_keluar/hapus/' . $item['id_barang_keluar']) ?>'); return false;">
